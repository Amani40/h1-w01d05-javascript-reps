...
```js
var favoriteMovies = [ 'Triple Frontier','Shooter','The Way Back','Safe House','Captian Phillips'];
```
...
function addMovie( newMovie) {
   ...
   OR:
   function addMovie( newMovie) {
   favoriteMovies[ favoriteMovies.length ] = newMovie;
   }
```
